...
${CXX:-c++} -std=c++17 -fPIC -DLOCALIZATION_WITHOUT_CATALOG -Irust/src tests/localization_smoke.cpp \
    $(pkg-config --cflags --libs Qt6Core Qt6Qml) -o "$test_dir/missing-catalog-test"
"$test_dir/missing-catalog-test"
