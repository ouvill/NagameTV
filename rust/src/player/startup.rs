...
impl Default for PlayerRust {
    fn default() -> Self {
        ...
        let mut player = Self {
            ...
            guide_model: crate::guide_model::ffi::make_guide_model(),
            epg_events: Default::default(),
            epg_status: super::status::tr("Disabled"),
            guide_error: None,
            current_program_data: QString::from("null"),
            program_progress: 0.0,
            program_status: QString::from("pending"),
            current_projection: Default::default(),
            program_publication: Default::default(),
            recording_program_bodies: Default::default(),
            program_enrichment: Default::default(),
