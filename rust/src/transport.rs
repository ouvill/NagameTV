...
use crate::subtitles::{CaptionDecoder, SubtitleCue};
...
mod tests {
    ...
    #[test]
    fn updates_audio_mapping_with_subtitles_disabled_from_fragmented_pmt() {
        ...
        let mut extractor = TransportParser::new(false);
